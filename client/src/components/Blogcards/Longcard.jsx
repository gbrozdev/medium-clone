...
function Longcard() {
    return (
        <div>
            <div className="my-8 bg-white text-gray-900">
                <div className="container grid grid-cols-12 mx-auto bg-gray-50">
                    <div style={{backgroundImage: `url("https://source.unsplash.com/random/480x360")` }} className="bg-no-repeat bg-cover bg-gray-700 col-span-full lg:col-span-4" >                    </div>
                    <div className="flex flex-col p-6 col-span-full row-span-full lg:col-span-8 lg:p-10">
                        <div className="flex justify-start">
                            <span className="px-2 py-1 text-xs rounded-full bg-indigo-600 text-gray-50">Label</span>
                        </div>
                        ...
                        <Link to="/" rel="noopener noreferrer" href="#" className="inline-flex items-center pt-2 pb-6 space-x-2 text-sm text-indigo-600">
                            <span>Read more</span>
